...
.editparty_transparty { grid-area: transparty; }
.editparty_institution { grid-area: institution; }
.editparty_partydesc { grid-area: partydesc; }
.editparty_transactions { grid-area: transactions; }
